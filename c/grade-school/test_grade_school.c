...
{
    roster_t input = {
        3, {(student_t){2, "Blair"}, (student_t){2, "James"}, (student_t){2, "Paul"}}};
...
{
    roster_t input = {
        2, {(student_t){3, "Chelsea"}, (student_t){7, "Logan"}}};
...
test_student_names_with_grades_displayed_in_the_same_sorted_roster(void)
{
    ...
    roster_t expected = {
        7, {(student_t){1, "Anna"}, (student_t){1, "Barb"}, (student_t){1, "Charlie"}, (student_t){2, "Alex"}, (student_t){2, "Peter"}, (student_t){2, "Zoe"}, (student_t){3, "Jim"}}};
...
int main(void)
{
    ...
    RUN_TEST(test_adding_students_to_different_grades_adds_to_the_same_sorted_roster);
    RUN_TEST(test_student_cannot_be_added_to_more_than_one_grade_in_the_sorted_roster);
    ...
    RUN_TEST(test_grade_returns_an_empty_list_if_there_are_no_students_in_that_grade);
